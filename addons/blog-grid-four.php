...
class tortoiz_blog_Blog_Grid_Four extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'tortoiz_blog-blog-grid-four';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Blog Grid Four', 'tortoiz_blog' );
	}
			        ...
			        <div class="entry-thumb">
			            <figure class="thumb-wrap">
			                <a href="<?php the_permalink(); ?>">
			                    <img src="<?php the_post_thumbnail_url('tortoiz_blog-blog-grid-five') ?>" alt="post">
			                </a>
			            </figure><!--./ thumb-wrap -->
			        </div><!--./ entry-thumb -->
			        <?php endif ?>
