...
class tortoiz_blog_Blog_Grid_Three extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'tortoiz_blog-blog-grid-three';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Blog Grid Three', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="row">
			...
			<!--~~~~~ Start Post ~~~~~-->
			<div class="col-lg-12">
			    <article class="post hentry style-seven text-center">

			    	<?php if ($settings['show_thumb']) : ?>
			        <div class="entry-thumb">
			            <figure class="thumb-wrap">
			                <a href="<?php the_permalink(); ?>">
			                    <img src="<?php the_post_thumbnail_url('tortoiz_blog-blog-grid-four') ?>" alt="post">
			                </a>
			            </figure><!--./ thumb-wrap -->
			        </div><!--./ entry-thumb -->
			        <?php endif ?>
