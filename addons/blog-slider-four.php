...
class tortoiz_blog_Blog_Slider_Four extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'blog-slider-four';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Blog Slider Four', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="frontpage-slider-posts slider-style-two slider-style-six">
            <div id="frontpage-slider" class="owl-carousel frontpage-slider-two carousel-nav-align-center"> 
                ...
                <article class="slider-item">
                    ...
                    <figure class="slider-thumb">  
                        <img src="<?php the_post_thumbnail_url('tortoiz_blog-blog-slider-one'); ?>" alt="Thmubnail">  
                    </figure><!--./ slider-thumb -->
                    <?php endif ?>
