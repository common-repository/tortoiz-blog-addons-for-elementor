...
class tortoiz_blog_Blog_Slider_One extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'blog-slider-one';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Blog Slider One', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="frontpage-slider-posts slider-style-two slider-style-four">
