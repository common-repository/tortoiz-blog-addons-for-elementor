...
class tortoiz_blog_Blog_Slider_Three extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'blog-slider-three';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Blog Slider Three', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="row">
            <div class="col-12">
                <div id="trending-posts-carousel" class="owl-carousel carousel-nav-dots">
					<?php
						if($blog->have_posts()) : while($blog->have_posts()) : $blog->the_post();
					?>
                    <!--~~~~~ Start Post ~~~~~-->
                    <article class="post hentry post-grid style-seven text-center">
                        <div class="entry-thumb">
                            
		                    <?php if ($settings['show_thumb']) : ?>
		                    <figure class="slider-thumb">  
		                        <img src="<?php the_post_thumbnail_url('tortoiz_blog-blog-slider-three'); ?>" alt="Thmubnail">  
		                    </figure><!--./ slider-thumb -->
		                    <?php endif ?>
