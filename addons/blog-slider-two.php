...
class tortoiz_blog_Blog_Slider_Two extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'blog-slider-two';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Blog Slider Two', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="frontpage-slider-posts slider-style-three slider-style-five">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div id="frontpage-slider" class="owl-carousel frontpage-slider-three carousel-nav-align-center"> 
							<?php
			                ...
			                <article class="slider-item">
			                    ...
			                    <figure class="slider-thumb">  
			                        <img src="<?php the_post_thumbnail_url('tortoiz_blog-blog-slider-two'); ?>" alt="Thmubnail">  
			                    </figure><!--./ slider-thumb -->
			                    <?php endif ?>

                                <div class="content-entry-wrap">
                                    <div class="content-entry-wrap-inner">
                                        <div class="content-entry-wrap-inner-inner">
