...
class tortoiz_blog_Magazine_Grid_Four extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'magazine-grid-four';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Magazine Grid Four', 'tortoiz_blog' );
	}
            ...
            <div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
					    <article class="featured-item small">

					    	<?php if ($settings['show_thumb']) : ?>
					        <figure class="featured-media"> 
					            <a href="<?php the_permalink(); ?>" class="featured-link"> 
					                <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-grid-four') ?>" alt="Thmubnail"> 
					            </a>
