...
class tortoiz_blog_Magazine_Grid_One extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'magazine-grid-one';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Magazine Grid One', 'tortoiz_blog' );
	}
			        ...
			        <div class="entry-thumb">
			            <figure class="thumb-wrap">
			                <a href="<?php the_permalink(); ?>">
			                    <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-grid-one') ?>" alt="post">
			                </a>
			            </figure><!--./ thumb-wrap -->
			        </div><!--./ entry-thumb -->
			        <?php endif ?>
