...
class tortoiz_blog_Magazine_Grid_Three extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'magazine-grid-three';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Magazine Grid Three', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		?>
		<div class="frontpage-featured-posts featured-style-five ptb-80">
            <div class="container">
				<div class="row">
					<?php
					...
					<!--~~~~~ Start Featured Item~~~~~-->
					<div class="col-lg-6">
					    <article class="featured-item medium">

					    	<?php if ($settings['show_thumb']) : ?>
					        <figure class="featured-media"> 
					            <a href="<?php the_permalink(); ?>" class="featured-link"> 
					                <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-grid-three') ?>" alt="Thmubnail"> 
					            </a>
