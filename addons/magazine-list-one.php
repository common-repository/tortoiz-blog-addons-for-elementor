...
class tortoiz_blog_Magazine_List_One extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'magazine-list-one';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Magazine List One', 'tortoiz_blog' );
	}
			        ...
			        <div class="entry-thumb">
			            <figure class="thumb-wrap">
			                <a href="<?php the_permalink(); ?>">
			                    <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-list-one') ?>" alt="post">
			                </a>
			            </figure><!--./ thumb-wrap -->
			        </div><!--./ entry-thumb -->
			        <?php endif ?>
