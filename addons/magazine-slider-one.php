...
class tortoiz_blog_Magazine_Slider_One extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'magazine-slider-one';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Magazine Slider One', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="frontpage-featured-posts featured-style-two">
				...
				<article class="featured-item">
				    ...
				    <figure class="featured-media"> 
				        <a href="<?php the_permalink(); ?>" class="featured-link"> 
				            <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-slider-one') ?>" alt="Thmubnail"> 
				        </a>
