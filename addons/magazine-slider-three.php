...
class tortoiz_blog_Magazine_Slider_Three extends \Elementor\Widget_Base {

	// Widget Name

	public function get_name() {
		return 'magazine-slider-three';
	}

	// Widget Titke

	public function get_title() {
		return __( 'Magazine Slider Three', 'tortoiz_blog' );
	}
	...
	protected function render() {
		...
		<div class="frontpage-featured-posts featured-style-three">
            <div id="featured-carousel-two" class="owl-carousel carousel-nav-dots">
				<?php
				...
				<article class="featured-item">
                    ...
                    <figure class="featured-media"> 
                        <a href="<?php the_permalink(); ?>" class="featured-link"> 
				            <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-slider-three') ?>" alt="Thmubnail"> 
				        </a>
