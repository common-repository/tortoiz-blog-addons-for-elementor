...
class tortoiz_blog_Standard_Post extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Standard Post', 'tortoiz_blog' );
	}
		        ...
		        <div class="entry-thumb">
		            <figure class="thumb-wrap">
		                <a href="<?php the_permalink(); ?>">
		                    <img src="<?php the_post_thumbnail_url('tortoiz_blog-magazine-standard') ?>" alt="post">
		                </a>
		            </figure><!--./ thumb-wrap -->
		        </div><!--./ entry-thumb -->
		        <?php endif ?>
