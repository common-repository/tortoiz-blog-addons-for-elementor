/*************************************************************************
    Template Name: tortoiz_blog
    Template URI: https://themeforest.net/user/tortoiz
    Description: A 'tortoiz_blog – Magazine and Blog Template' is perfect if you like a clean and modern design. This theme is ideal for Magazine, Blog, Post, Travel, Personal, and those who need an easy, attractive and effective way to share their work with clients.
    Author: tortoiz
    Version: 1.0
...
(function($) {
    ...
    var tortoiz_blogApp = { 
        ...
        sidebar_menu_and_search: function () {
            ...
            $('.tortoiz_blog-close-all-window, .sidebar-close-button').on('click', function(){
        ...
        --------------------------------------------- */
        scroll_bar: function() {
            // tortoiz_blog Sidebar Scroll
            //-------------------------------
            if ($('.tortoiz_blog-side-sidebar').length) {
                var $sidebar_scroll = $('.tortoiz_blog-side-sidebar');
        ...
        /* ---------------------------------------------
         ...
         --------------------------------------------- */
        initializ: function() {          
            tortoiz_blogApp.scroll_top();         
            tortoiz_blogApp.background_fit_image();         
            tortoiz_blogApp.sidebar_menu_and_search();         
            tortoiz_blogApp.mobile_menu();         
            tortoiz_blogApp.news_ticker();         
            tortoiz_blogApp.scroll_bar();         
            tortoiz_blogApp.sticky_sidebar(); 
            tortoiz_blogApp.frontpage_slider();       
            tortoiz_blogApp.widget_posts_slider();        
            tortoiz_blogApp.popular_posts_carousel();        
            tortoiz_blogApp.trending_posts_carousel();          
            tortoiz_blogApp.featured_slider();         
            tortoiz_blogApp.category_carousel();
            tortoiz_blogApp.single_post_slider();  
            tortoiz_blogApp.posts_load_more(); 
            tortoiz_blogApp.grid_masonry();        
            tortoiz_blogApp.search();        
        }
    };
